...
out.println("				</td>");
out.println("				");
out.println("    <td class=tablebody1 valign=\"middle\" width=\"60%\"> &nbsp;&nbsp;<a href=\"./three\">精通Hibernate：Java对象持久化技术详解</a> ");
out.println("    </td>");
out.println("				<td class=tablebody2 valign=\"middle\" align=\"center\" width=\"8%\">");
out.println("					59.0");
out.println("				</td>");
out.println("				");
out.println("    <td class=tablebody1 valign=\"middle\" align=\"center\" width=\"24%\"> <a href=\"./six\"><img border=\"0\" src=\"./images/car_new.gif\" width=\"97\" height=\"18\"></a> ");
out.println("    </td>");
out.println("			</tr>   ");
out.println("			<tr>");
out.println("				<td class=tablebody2 valign=\"middle\" align=\"center\" width=\"8%\">");
...
out.println("				</td>");
out.println("				");
out.println("    <td class=tablebody1 valign=\"middle\" width=\"60%\"> &nbsp;&nbsp;<a href=\"./three\">Effective ");
...
out.println("				</td>");
out.println("				");
out.println("    <td class=tablebody1 valign=\"middle\" width=\"60%\"> &nbsp;&nbsp;<a href=\"./three\">精通Spring</a> ");
out.println("    </td>");
out.println("				<td class=tablebody2 valign=\"middle\" align=\"center\" width=\"8%\">");
out.println("					39.0");
out.println("				</td>");
...
out.println("				</td>");
out.println("				");
out.println("    <td class=tablebody1 valign=\"middle\" width=\"60%\"> &nbsp;&nbsp;<a href=\"./three\">深入浅出Hibernate</a> ");
out.println("    </td>");
out.println("				<td class=tablebody2 valign=\"middle\" align=\"center\" width=\"8%\">");
out.println("					59.0");
out.println("				</td>");
...
out.println("				</td>");
out.println("				");
out.println("    <td class=tablebody1 valign=\"middle\" width=\"60%\"> &nbsp;&nbsp;<a href=\"./three\">JAVA编程思想：第3版</a> ");
out.println("    </td>");
out.println("				<td class=tablebody2 valign=\"middle\" align=\"center\" width=\"8%\">");
out.println("					95.0");
out.println("				</td>");
...
out.println("				</td>");
out.println("				");
out.println("    <td class=tablebody1 valign=\"middle\" width=\"60%\"> &nbsp;&nbsp;<a href=\"./three\">Java ");
...
out.println("				</td>");
out.println("				");
out.println("    <td class=tablebody1 valign=\"middle\" width=\"60%\"> &nbsp;&nbsp;<a href=\"./three\">Tomcat与Java ");
...
out.println("				</td>");
out.println("				");
out.println("    <td class=tablebody1 valign=\"middle\" width=\"60%\"> &nbsp;&nbsp;<a href=\"./three\">Java与模式</a> ");
out.println("    </td>");
out.println("				<td class=tablebody2 valign=\"middle\" align=\"center\" width=\"8%\">");
out.println("					88.0");
out.println("				</td>");
